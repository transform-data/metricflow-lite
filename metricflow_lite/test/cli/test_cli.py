...
from metricflow_lite.cli.main import (
...
from metricflow_lite.test.fixtures.cli_fixtures import MetricFlowCliRunner
...
def test_validate_configs(cli_runner: MetricFlowCliRunner) -> None:  # noqa: D
    ...
    with patch("metricflow_lite.cli.main.model_build_result_from_config", return_value=mocked_parsing_result):
        with patch("metricflow_lite.cli.main.path_to_models", return_value=""):
        ...
        with patch("metricflow_lite.cli.main.path_to_models", return_value=""):
            with patch.object(
                ...
                with patch.object(CLIContext, "sql_client", return_value=None):  # type: ignore
                    with patch(
                        "metricflow_lite.cli.main._run_dw_validations",
